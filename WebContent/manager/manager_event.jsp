...
<body>
	...
	<form action="<c:url value='/EventController?listManagerEvent' />" method="get">
		<table >
			<tr>
				<td>date (*): </td>
		...
		<br>
		<input name="action" value="listManagerEvent" type="hidden"><input type="submit" value="Submit">
	</form>
	<br><br>
	<table border="1" class="myTable">
			...
			<c:forEach items="${EVENTS}" var="item" varStatus="status">
				<tr class="myTableRow">
					...
					<td> <a href="<c:url value='/EventController?action=listSpecificManagerEvent&id=${item.id}' />">View</a></td>
