	...
	<div class="content">
		...
		<div class="menu_nav">
			<ul>
						...
						<li><a href="<c:url value='/EventController?action=reserveEventGet' />"><span>Request an Event</span></a></li>
						<li><a href="<c:url value='/EventController?action=getEvent' />"><span>View All Events</span></a></li>
						<li><a href="<c:url value='/UserController?action=getUserUpdate' />"><span>View Profile</span></a></li>
